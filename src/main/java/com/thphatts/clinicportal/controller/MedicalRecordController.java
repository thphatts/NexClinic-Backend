...
public class MedicalRecordController extends BaseController {
    ...
    public ApiResponse<PagedResponse<MedicalRecordResponse>> getAllMedicalRecords(
        ...
        return ApiResponse.success(medicalRecordService.getAllMedicalRecords(pageable, currentUser));
    }
    ...
    public ApiResponse<MedicalRecordResponse> getMedicalRecordById(
        ...
        return ApiResponse.success(medicalRecordService.getMedicalRecordById(id, currentUser));
    }
    ...
    public ApiResponse<MedicalRecordResponse> getMedicalRecordByAppointmentId(
        ...
        return ApiResponse.success(medicalRecordService.getMedicalRecordByAppointmentId(appointmentId, currentUser));
    }
    ...
    public ApiResponse<List<MedicalRecordResponse>> getMedicalRecordsByPatientId(
        ...
        return ApiResponse.success(medicalRecordService.getMedicalRecordsByPatientId(patientId, currentUser));
    }

    @GetMapping("/doctor/{doctorId}")
    public ApiResponse<List<MedicalRecordResponse>> getMedicalRecordsByDoctorId(
            @PathVariable("doctorId") Long doctorId,
            @AuthenticationPrincipal UserPrincipal currentUser
    ) {
        return ApiResponse.success(medicalRecordService.getMedicalRecordsByDoctorId(doctorId, currentUser));
    }
}
